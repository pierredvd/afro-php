<?php
    ...
    abstract class Error{
        ...
        public static function init($onError=null, $showError=false){
            ...
            if(function_exists('set_exception_handler')     ){ set_exception_handler(       '\Afro\Error::exception'                ); }
            if(function_exists('set_exception_handler')     ){ set_error_handler(           '\Afro\Error::error', E_ALL | E_STRICT  ); }
            if(function_exists('register_shutdown_function')){ register_shutdown_function(  '\Afro\Error::shutdown'                 ); }
        }
